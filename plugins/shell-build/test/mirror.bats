...
export SHELL_BUILD_CACHE_PATH=
export SHELL_BUILD_MIRROR_URL=http://mirror.example.com
...
@test "package URL with checksum hits mirror first" {
  ...
  local mirror_url="${SHELL_BUILD_MIRROR_URL}/$checksum"
...
@test "package URL with ruby-lang CDN with default mirror URL will bypasses mirror" {
  ...
  stub shasum true "echo $checksum"
  stub curl "-q -o * -*S* https://www.shell.org/* : cp $FIXTURE_ROOT/\${5##*/} \$3"

  run_inline_definition <<DEF
install_package "package-1.0.0" "https://www.shell.org/packages/package-1.0.0.tar.gz#ba988b1bb4250dee0b9dd3d4d722f9c64b2bacfc805d1b6eba7426bda72dd3c5" copy
DEF
